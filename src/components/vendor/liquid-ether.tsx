// Liquid Ether — React Bits. Codigo de terceiro, mantido como veio.
//
// Simulacao de fluido em WebGL: o ponteiro empurra velocidade num campo, o campo
// e resolvido a cada quadro (adveccao, viscosidade, pressao) e as cores sao so a
// leitura desse campo. Sem ponteiro ele se move sozinho (`autoDemo`).
//
// Alteracoes locais em relacao ao original:
//   1. Adicionado o "use client" — o original vem do catalogo deles sem a diretiva
//      e o App Router precisa dela.
//   2. Nada mais. Ele ja escuta o ponteiro em `window` (ver `listenerTarget`), que
//      e o que faz o efeito continuar respondendo mesmo como fundo com
//      `pointer-events: none`. Se atualizar, recopiar do React Bits.
